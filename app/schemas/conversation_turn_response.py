...
class ConversationTurnResponse(BaseModel):
    ...
    answer: str = Field(
        ...,
        description="Generated answer for this conversation turn"
    )
    
    turn_index: int = Field(
        ...,
        ge=0,
        description="Zero-based index of this turn in the conversation"
    )
    
    context_tokens_used: int = Field(
        ...,
        ge=0,
        description="Estimated number of tokens used for context in this turn"
    )
